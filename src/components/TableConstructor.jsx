...
const TableConstructor = (props) => {
  const { nodes, materials } = useGLTF('models/tableConstructor.gltf')
  console.log(useGLTF('models/tableConstructor.gltf'));
  const { legsColor, tabletopGeometry, legsType } = useCustomization()
  ...
  /* let selectedLegsType = null;
  if (legsType.title === "Skver") {
    selectedLegsType = 
  } */
  console.log(nodes);
  return (
...
useGLTF.preload('models/tableConstructor.gltf')
